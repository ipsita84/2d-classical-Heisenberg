...
// code for plotting tau versus angle, where tau = m x h, m=magnetization,
// h = external magnetic field, we fix |h| = 30 K, T = 1 K
...
int main(int argc, char const * argv[])
{
    ...
    ifstream gin("J1.dat");
    ofstream f1out("mag1_theta_hxhz.dat",std::fstream::app);	// Opens a file for output
    ofstream fout("Energy1_theta_hxhz.dat", std::fstream::app);
